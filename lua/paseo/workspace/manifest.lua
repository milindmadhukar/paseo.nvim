...
function M.render(m, notes)
  ...
  local out = {
    ...
    "# Check the commented lines: they are what init could not decide for you.",
    "",
  }
  ...
  if m.shared and #m.shared > 0 then
    vim.list_extend(out, {
      ...
      "# init lists every non-repo directory it found; PRUNE THIS. It cannot tell",
      "# a shared reference folder from a directory that merely happens to be here.",
